...
public class CardRepository {
    ...
    public enum CardTemplate {
        ...
        FireElemental(3, "Fire elemental", 1, 1, 2, "BATTLECRY: DEALS 2 energy damage to chosen ENEMY CARD",
        ...
        IceElemental(5, "Ice elemental", 2, 1, 1, "BATTLECRY: FREEZES chosen ENEMY CARD", DEFAULT_PATH + "/ice_elemental.png",
                List.of(Action.FREEZE_ENEMY_ON_PLAY), List.of(KeyWord.BATTLE_CRY, KeyWord.FREEZE), Faction.ELEMENTAL, Rarity.COMMON, Map.of()),
        TheRock(6, "The Rock", 4, 4, 5, "PUNISHMENT: DEALS damage equal to its attack to ENEMY HERO, GAINS +2/1", DEFAULT_PATH + "/dwayne_rock.png",
        ...
        Phoenix(9, "Phoenix", 4, 4, 4, "BATTLECRY: DEALS 2 energy damage to chosen ENEMY CARD", DEFAULT_PATH + "/phoenix.png",
        ...
        FierceTiger(11, "Fierce tiger", 3, 3, 4, "RUSH", DEFAULT_PATH + "/tiger.png", List.of(Action.RUSH_ON_PLAY), List.of(KeyWord.RUSH), Faction.ANIMAL,
                Rarity.COMMON, Map.of()),
        StoneAssassin(12, "Stone assassin", 2, 2, 5, "BATTLECRY: DESTROYS chosen ENEMY CARD. ALIGNMENT: void", DEFAULT_PATH + "/stone_assassin.png",
        ...
        TheGreatestApex(15, "The greatest apex", 7, 7, 8, "RUSH", DEFAULT_PATH + "/greatest_apex.png",
        ...
        IceSorcerer(24, "Ice sorcerer", 4,4, 5, "BATTLECRY: FREEZES chosen ENEMY CARD", DEFAULT_PATH + "/ice_sorcerer.png",
