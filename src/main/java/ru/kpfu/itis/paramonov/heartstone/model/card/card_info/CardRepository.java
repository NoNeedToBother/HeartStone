...
public class CardRepository {
    ...
    public enum Faction {
        STONE, ELEMENTAL, ANIMAL, ROBOT, PIRATE
    }
    ...
    public enum CardTemplate {
        Stone(1, "Stone", 1, 1, 0, "", "basic_stone.png", List.of(), List.of(),
                List.of(Faction.STONE), Rarity.COMMON, Map.of()),

        KnightStone(2, "Stoneland knight", 4, 4, 4, "TAUNT", "knight_stone.png",
                List.of(), List.of(KeyWord.TAUNT), List.of(Faction.STONE), Rarity.COMMON, Map.of()),
        FireElemental(3, "Fire elemental", 1, 2, 2, "BATTLECRY: DEALS 2 energy damage to chosen ENEMY CARD",
                ...
                List.of(Faction.ELEMENTAL), Rarity.COMMON, Map.of(StatChange.DMG, 2)),
        FirePack(4, "Fire elemental pack", 5, 5, 5, "", "fire_pack.png", List.of(),
                List.of(), List.of(Faction.ELEMENTAL), Rarity.COMMON, Map.of()),
        ...
        Whelp(8, "Dragon whelp", 3, 5, 4, "", "whelp.png", List.of(), List.of(),
                List.of(Faction.ANIMAL), Rarity.COMMON, Map.of()),
        Phoenix(9, "Phoenix", 4, 4, 4, "BATTLECRY: DEALS 2 energy damage to chosen ENEMY CARD", "phoenix.png",
                List.of(Action.DAMAGE_ENEMY_ON_PLAY, Action.DEAL_ENERGY_DMG), List.of(KeyWord.BATTLE_CRY), List.of(Faction.ELEMENTAL, Faction.ANIMAL),
                Rarity.RARE, Map.of(StatChange.DMG, 2)),
        StoneGiant(10, "Stone giant", 6, 6, 10, "GIANT: cost -1 for each played STONE. ALIGNMENT: life", "stone_giant.png",
                List.of(Action.DEAL_LIFE_DMG), List.of(KeyWord.GIANT, KeyWord.ALIGNMENT), List.of(Faction.STONE), Rarity.EPIC, Map.of(StatChange.COST, -1)),
        FierceTiger(11, "Fierce tiger", 3, 3, 4, "RUSH", "tiger.png", List.of(Action.RUSH_ON_PLAY),
                List.of(KeyWord.RUSH), List.of(Faction.ANIMAL), Rarity.COMMON, Map.of()),
        StoneAssassin(12, "Stone assassin", 2, 2, 5, "BATTLECRY: DESTROYS chosen ENEMY CARD. ALIGNMENT: void", "stone_assassin.png",
                List.of(Action.DESTROY_ENEMY_ON_PLAY, Action.DEAL_VOID_DMG), List.of(KeyWord.BATTLE_CRY, KeyWord.DESTROY, KeyWord.ALIGNMENT), List.of(Faction.STONE), Rarity.EPIC, Map.of()),
        CrazyPyromaniac(13, "Crazy pyromaniac", 4, 4, 5, "BATTLECRY: DEALS 2 damage to ALL other cards", "crazy_pyromaniac.png",
                List.of(Action.DAMAGE_ALL_ON_PLAY), List.of(KeyWord.BATTLE_CRY), List.of(Faction.ELEMENTAL), Rarity.RARE, Map.of(StatChange.ALL_DMG, 2)),
        Trantos(14, "Tran'tos", 3, 3, 6, "Battlecry: DEALS 3 damage to ALL other cards. For each defeated card GAINS +2/1",
                ...
                List.of(Faction.ELEMENTAL), Rarity.LEGENDARY, Map.of(StatChange.ALL_DMG, 3, StatChange.ATK, 2, StatChange.HP, 1)),
        TheGreatestApex(15, "The greatest apex", 7, 7, 8, "RUSH", "greatest_apex.png",
                List.of(Action.RUSH_ON_PLAY), List.of(KeyWord.RUSH), List.of(Faction.ANIMAL), Rarity.LEGENDARY, Map.of()),
        Slime(16, "Slime", 2, 2, 1, "", "slime.png", List.of(), List.of(),
                List.of(), Rarity.COMMON, Map.of()),
        ...
        WaterGiant(18, "Water giant", 5, 4, 10, "GIANT: cost -1 for each played ELEMENTAL. RUSH", "water_giant.png",
                List.of(Action.RUSH_ON_PLAY), List.of(KeyWord.GIANT, KeyWord.RUSH), List.of(Faction.ELEMENTAL), Rarity.EPIC, Map.of(StatChange.COST, -1)),
        STAN_3000(19, "STAN-3000", 7, 7, 12, "GIANT: cost -1 for each played ROBOT. TAUNT", "stan3000.png",
                List.of(), List.of(KeyWord.GIANT, KeyWord.TAUNT), List.of(Faction.ROBOT), Rarity.EPIC, Map.of(StatChange.COST, -1)),
        A_50(20, "A-50", 3, 4, 3, "", "a50.png", List.of(), List.of(),
                List.of(Faction.ROBOT), Rarity.COMMON, Map.of()),
        B_30(21, "B-30", 3, 2, 6, "BATTLECRY: DEALS 5 damage. RUSH","b30.png", List.of(Action.DAMAGE_ENEMY_ON_PLAY, Action.RUSH_ON_PLAY),
                List.of(KeyWord.BATTLE_CRY, KeyWord.RUSH), List.of(Faction.ROBOT), Rarity.RARE, Map.of(StatChange.DMG, 5)),
        TENS_100(22, "TENS-1000", 4, 5, 5, "RUSH. IGNORES taunt", "tens100.png",
                List.of(Action.RUSH_ON_PLAY, Action.IGNORE_TAUNT), List.of(KeyWord.RUSH), List.of(Faction.ROBOT), Rarity.LEGENDARY, Map.of()),
        Ninja(23, "Ninja", 4, 4, 5, "IGNORES taunt. ALIGNMENT: void", "ninja.png", List.of(Action.IGNORE_TAUNT, Action.DEAL_VOID_DMG),
                List.of(KeyWord.ALIGNMENT), List.of(), Rarity.RARE, Map.of()),
        IceSorcerer(24, "Ice sorcerer", 4,4, 5, "BATTLECRY: FREEZES chosen ENEMY CARD", "ice_sorcerer.png",
                List.of(Action.FREEZE_ENEMY_ON_PLAY), List.of(KeyWord.BATTLE_CRY, KeyWord.FREEZE), List.of(Faction.ELEMENTAL), Rarity.COMMON, Map.of()),
        Rat(25, "Rat", 3, 2, 2, "", "rat.png", List.of(), List.of(), List.of(Faction.ANIMAL), Rarity.COMMON, Map.of()),
        Dragon(26, "The Dragon", 8, 8, 8, "BATTLECRY: DRAW a card. TAUNT", "dragon.png", List.of(Action.DRAW_CARD_ON_PLAY),
                List.of(KeyWord.BATTLE_CRY, KeyWord.TAUNT), List.of(Faction.ANIMAL), Rarity.RARE, Map.of(StatChange.CARD_DRAWN, 1)),
        Illusionist(27, "Illusionist", 3, 4, 3, "BATTLECRY: both player DRAW 2 cards. ALIGNMENT: intelligence", "illusionist.png",
                List.of(Action.DRAW_CARD_ON_PLAY, Action.DEAL_INTELLIGENCE_DMG), List.of(KeyWord.BATTLE_CRY, KeyWord.ALIGNMENT),
                List.of(), Rarity.EPIC, Map.of(StatChange.CARD_DRAWN, 2)),
        ProfessorDog(28, "Professor Dog", 3, 3, 5, "Whenever you DRAW a card GAINS +2/2. ALIGNMENT: intelligence", "prof_dog.png",
                List.of(Action.DEAL_INTELLIGENCE_DMG), List.of(KeyWord.ALIGNMENT), List.of(Faction.ANIMAL), Rarity.LEGENDARY, Map.of(StatChange.ATK, 2, StatChange.HP, 2)),
        ...
        MerchantRobot(32, "Merchant robot", 2, 2, 3, "BATTLECRY: DRAW a card. ALIGNMENT: life", "merchant_robot.png",
                List.of(Action.DRAW_CARD_ON_PLAY, Action.DEAL_LIFE_DMG), List.of(KeyWord.BATTLE_CRY, KeyWord.ALIGNMENT),
                List.of(Faction.ROBOT), Rarity.RARE, Map.of(StatChange.CARD_DRAWN, 1)),
        BraveRat(33, "Brave rat", 4, 2, 4, "RUSH", "brave_rat.png",
                List.of(Action.RUSH_ON_PLAY), List.of(KeyWord.RUSH), List.of(Faction.ANIMAL), Rarity.COMMON, Map.of()),
        SwampThing(34, "Swamp thing", 4, 6, 5, "TAUNT. ALIGNMENT: chaos", "swamp_thing.png",
                List.of(Action.DEAL_CHAOS_DMG), List.of(KeyWord.TAUNT, KeyWord.ALIGNMENT), List.of(), Rarity.RARE, Map.of()),
        Hydra(35, "Hydra", 4, 5, 7, "BATTELCRY: DESTROYS chosen ENEMY CARD", "hydra.png", List.of(Action.DESTROY_ENEMY_ON_PLAY),
                List.of(KeyWord.BATTLE_CRY, KeyWord.DESTROY), List.of(Faction.ANIMAL), Rarity.RARE, Map.of()),
        AnimalKing(36, "King of animals", 6, 6, 10, "GIANT: cost -1 for each played ANIMAL. ALIGNMENT: strength", "animal_king.png",
                List.of(Action.DEAL_STRENGTH_DMG), List.of(KeyWord.GIANT, KeyWord.ALIGNMENT), List.of(Faction.ANIMAL), Rarity.EPIC, Map.of(StatChange.COST, -1)),
        Deity(37, "His deity", 8, 8, 20, "GIANT: cost -6 for each played GIANT. ALIGNMENT: chaos", "his_deity.png",
                List.of(Action.DEAL_CHAOS_DMG), List.of(KeyWord.GIANT, KeyWord.ALIGNMENT), List.of(), Rarity.LEGENDARY, Map.of(StatChange.COST, -6)),
        BuriedColossus(38, "Buried colossus", 4, 8, 5, "TAUNT. Cannot attack", "buried_colossus.png",
                List.of(), List.of(KeyWord.TAUNT), List.of(Faction.STONE), Rarity.RARE, Map.of()),
        HeartStone(39, "HeartStone", 3, 4, 4, "TAUNT. Cannot attack. PUNISHMENT: DEALS 2 damage to ENEMY HERO",
                ...
                List.of(Faction.STONE), Rarity.RARE, Map.of(StatChange.HERO_DMG, 2)),
        ...
        GuardRobot(41, "Robot of Royal Guard", 4, 4, 5, "TAUNT. SHIELD", "royal_guard_robot.png",
                List.of(Action.SHIELD_ON_PLAY), List.of(KeyWord.TAUNT, KeyWord.SHIELD), List.of(Faction.ROBOT), Rarity.RARE, Map.of()),
        LightVindicator(42, "Vindicator of Light", 4, 3, 4, "SHIELD", "light_vindicator.png", List.of(Action.SHIELD_ON_PLAY),
                List.of(KeyWord.SHIELD), List.of(Faction.ELEMENTAL), Rarity.COMMON, Map.of()),
        ...
        BoardingPirate(44, "Boarding pirate", 4, 3, 4, "BOARD!", "boarding_pirate.png", List.of(Action.BOARD_ON_PLAY),
                List.of(KeyWord.BOARD), List.of(Faction.PIRATE), Rarity.COMMON, Map.of()),
        MutantCrab(45, "Mutant crab", 3, 3, 5, "BOARD. When attacking ENEMY CARD DEALS same damage to adjacent cards", "mutant_crab.png",
                List.of(Action.BOARD_ON_PLAY, Action.ATTACK_ADJACENT_CARDS), List.of(KeyWord.BOARD), List.of(Faction.ANIMAL), Rarity.RARE, Map.of()),
        Paladin(46, "Paladin", 4, 4, 6, "BATTLECRY: GIVES SHIELD to 2 adjacent cards. ALIGNMENT: life", "paladin.png",
                List.of(Action.GIVE_SHIELD_ON_PLAY, Action.DEAL_LIFE_DMG), List.of(KeyWord.BATTLE_CRY, KeyWord.SHIELD,
                KeyWord.ALIGNMENT), List.of(), Rarity.EPIC, Map.of()),
        ...
        IceMage(48, "Ice mage", 1, 2, 3, "BATTLECRY: FREEZES chosen ENEMY CARD and adjacent cards", "ice_mage.png",
                List.of(Action.FREEZE_ADJACENT_CARDS_ON_PLAY), List.of(KeyWord.BATTLE_CRY, KeyWord.FREEZE), List.of(), Rarity.RARE, Map.of()),
        StudyingApe(49, "Studying ape", 2, 3, 3, "When turn ENDS, adds random ANIMAL card to your HAND", "studying_ape.png",
                List.of(Action.GIVE_CARD_ON_TURN_END), List.of(), List.of(Faction.ANIMAL), Rarity.COMMON, Map.of()),
        PirateParrot(50, "Pirate parrot", 4, 3, 4, "When attacking ENEMY CARD DEALS same damage to adjacent cards", "pirate_parrot.png",
                List.of(Action.ATTACK_ADJACENT_CARDS), List.of(), List.of(Faction.ANIMAL, Faction.PIRATE), Rarity.RARE, Map.of());
        ...
        CardTemplate(int id, String name, int atk, int hp, int cost, String actionDesc, String imageUrl, List<Action> actions,
                     List<KeyWord> keyWords, List<Faction> factions, Rarity rarity, Map<StatChange, Integer> statChanges) {
            this.id = id;
            this.name = name;
            this.hp = hp;
            this.atk = atk;
